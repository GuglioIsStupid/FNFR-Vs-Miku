...
return {
	...
	setupTransitionSprites = function(self)
		self.transIn = love.filesystem.load("sprites/mikuMenu/transIn.lua")()
		self.transOut = love.filesystem.load("sprites/mikuMenu/transOut.lua")()
	end,

	mikuTransitionIn = function(self, func)
		Timer.after(0.5, function()
			self.transitionType = "in"
			self.transIn:animate("anim", false, function()
	...
	mikuTransitionOut = function(self, func)
		self.transitionType = "out"
		self.transOut:animate("anim", false, function()
			if func then func() end
		end)
	end,
