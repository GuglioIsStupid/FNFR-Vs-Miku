...
return graphics.newSprite(
    images.icons,
	{
		...
		{x = 0, y = 150, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 11: Miku
		{x = 150, y = 150, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 12: i Losing
		...
		{x = 1050, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 25: carol
		{x = 1200, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 26: tricky
		{x = 1350, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 26: tricky losing
	},
	{
		...
		["miku"] = {start = 11, stop = 11, speed = 0, offsetX = 0, offsetY = 0},
		["miku losing"] = {start = 12, stop = 12, speed = 0, offsetX = 0, offsetY = 0},
		...
		["carol"] = {start = 25, stop = 25, speed = 0, offsetX = 0, offsetY = 0},
		["tricky"] = {start = 26, stop = 26, speed = 0, offsetX = 0, offsetY = 0},
		["tricky losing"] = {start = 27, stop = 27, speed = 0, offsetX = 0, offsetY = 0},
	},
	"bf",
	false
)
